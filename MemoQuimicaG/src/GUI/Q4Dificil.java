...
public class Q4Dificil extends javax.swing.JFrame {
    ...
    public Q4Dificil() {
        ...
        setTitle("Memorama Quimica Termoquimica 4 Dificil");
        Ordenar();
    }
    ...
    private void Ordenar() {//ordena cartas de forma aleatoria al iniciar el programa
        ...
        jbt17.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[16] + ".png")));
        jbt18.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[17] + ".png")));
        jbt19.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[18] + ".png")));
        jbt20.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[19] + ".png")));
        jbt21.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[20] + ".png")));
        jbt22.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[21] + ".png")));
        jbt23.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[22] + ".png")));
        jbt24.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenesQ4/carta" + Arreglo[23] + ".png")));
